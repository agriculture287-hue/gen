    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left space-y-6 z-10">
          ...
          {/* Top Pill Badge */}
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-white border border-emerald-200 shadow-sm text-xs font-semibold text-slate-700">
            <GenMusicLogo size="xs" glow={false} />
            <span className="text-emerald-700 font-bold">Android Mobile App</span>
            <span className="text-slate-400">•</span>
            <span className="text-blue-700 font-bold">Latest {androidApp?.version || 'v2.5.0'}</span>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2.5 text-xs text-slate-500 pt-1">
            ...
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-xl bg-white text-slate-700 font-semibold border border-slate-200 shadow-xs">
              <Smartphone className="w-3.5 h-3.5 text-emerald-600" /> Android Mobile APK (Phones & Tablets)
            </span>
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-xl bg-emerald-50 text-emerald-700 font-semibold border border-emerald-200 shadow-xs">
              <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" /> 100% Free Forever
            </span>
          </div>
