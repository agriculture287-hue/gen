        ...
        <div className="flex items-center gap-2.5 flex-1 justify-center text-center flex-wrap">
          ...
          <p className="text-slate-700 font-medium text-xs sm:text-sm">
            {announcementText ? (
              ...
              <>
                <strong className="text-slate-900 font-bold">GEN MUSIC Mobile Beta is Available Now</strong>
                <span className="hidden sm:inline text-slate-600"> — Download Android Mobile APK or join Telegram.</span>
              </>
            )}
          </p>
